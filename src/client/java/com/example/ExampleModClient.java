...
import com.example.module.AimAssistModule;
...
import com.example.module.ProjectileTrajectoryModule;
...
public class ExampleModClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		moduleManager.register(new AntiSlowModule());
		...
		moduleManager.register(new EnemyHighlightModule());
		...
		moduleManager.register(new HitDelayOptimizerModule());
		...
		moduleManager.register(new ProjectileTrajectoryModule());
