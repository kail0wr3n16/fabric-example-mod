...
import com.example.module.AutoJumpResetModule;
import com.example.module.AutoRefillModule;
import com.example.module.AutoSprintModule;
import com.example.module.AutoToolModule;
import com.example.module.AutoTotemReminderModule;
import com.example.module.ChatCleanerModule;
import com.example.module.ChatTimestampModule;
import com.example.module.ComboCounterModule;
import com.example.module.CpsGraphModule;
import com.example.module.CrystalDangerAlertModule;
import com.example.module.CustomCrosshairModule;
import com.example.module.DeathMarkerModule;
import com.example.module.DurabilityWatchModule;
import com.example.module.FocusModeModule;
import com.example.module.FovMemoryModule;
import com.example.module.FullbrightModule;
import com.example.module.HitStatsModule;
import com.example.module.ItemTooltipModule;
import com.example.module.Module;
import com.example.module.MovementHeatmapModule;
import com.example.module.ModuleManager;
import com.example.module.OverlayModule;
import com.example.module.ParkourAssistModule;
import com.example.module.PlayerNotesModule;
import com.example.module.PotionTimerHudModule;
import com.example.module.ResourcePingModule;
...
public class ExampleModClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		moduleManager.register(new CpsGraphModule());
		moduleManager.register(new ComboCounterModule());
		moduleManager.register(new CrystalDangerAlertModule());
		moduleManager.register(new DurabilityWatchModule());
		moduleManager.register(new HitStatsModule());
		...
		// ── QOL ──────────────────────────────────────────────────────
		moduleManager.register(new AutoRefillModule());
		moduleManager.register(new AutoSprintModule());
		moduleManager.register(new AutoToolModule());
		moduleManager.register(new DeathMarkerModule());
		moduleManager.register(new FovMemoryModule());
		moduleManager.register(new ItemTooltipModule());
		moduleManager.register(new ParkourAssistModule());
		moduleManager.register(new ResourcePingModule());
		moduleManager.register(new ScreenshotModule());
		moduleManager.register(new WaypointsModule());
		moduleManager.register(new ZoomModule());

		// ── RENDER ───────────────────────────────────────────────────
		moduleManager.register(new AdaptiveUiModule());
		moduleManager.register(new CustomCrosshairModule());
		moduleManager.register(new FullbrightModule());
		moduleManager.register(new MovementHeatmapModule());
		moduleManager.register(new TrailModule());

		// ── SOCIAL ───────────────────────────────────────────────────
		moduleManager.register(new ChatCleanerModule());
		moduleManager.register(new ChatTimestampModule());
		moduleManager.register(new PlayerNotesModule());

		// ── ACCESSIBILITY ────────────────────────────────────────────
		moduleManager.register(new AutoJumpResetModule());
		moduleManager.register(new FocusModeModule(moduleManager));
		...
		ClientPlayConnectionEvents.JOIN.register((handler, sender, client) -> {
			if (client.player != null) {
				client.player.sendSystemMessage(Component.literal("§bClient modules loaded"));
			}
		});
	}
